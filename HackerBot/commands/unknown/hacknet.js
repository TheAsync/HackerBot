...
module.exports = {
  cooldown: 5,
	data: new SlashCommandBuilder()
		.setName('hacknet')
    .setDescription('=¤&#- T63 h4ckn3t -#&¤=')
    .addSubcommand(subcommand =>
  		subcommand
  			.setName('create')
  			.setDescription('Create a hacknet node on this server')
    )
    .addSubcommand(subcommand =>
      subcommand
        .setName('delete')
        .setDescription('select and delete a hacknet node')
    )
  	.addSubcommand(subcommand =>
  		subcommand
  			.setName('analyze')
  			.setDescription('gather info about the servers hacknet nodes')
    )
    .addSubcommand(subcommand =>
  		subcommand
  			.setName('info')
  			.setDescription('get info about your nodes')
    )
    .addSubcommand(subcommand =>
      subcommand
        .setName('help')
